...
{
    /// <inheritdoc />
    public partial class AddingJunctionTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverOrder", x => new { x.DriverId, x.OrderId });
                    table.ForeignKey(
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Clients_salesPeople_SalesPersonId",
                table: "Clients",
                column: "SalesPersonId",
